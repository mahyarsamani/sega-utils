...
int main(int argc, char** argv) {
    if (argc == 1) {
        ...
        << "[graph_path: str] [main_path: str] [mirrors_path: str] "
    ...
    std::string main_path = argv[2];
    std::string mirrors_path = argv[3];
    ...
    SlicedGraphReader graph_reader(graph_path, main_path, mirrors_path, weighted,
